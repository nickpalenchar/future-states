...
describe('Agenda API Router:', function () {
  ...
  describe('GET /api/agendas', function () {
    ...
    it('should route to agenda.controller.index', function () {
      routerStub.get.withArgs('/', 'agendaCtrl.index').should.have.been.calledOnce;
    });
  });
  ...
  describe('GET /api/agendas/:id', function () {
    ...
    it('should route to agenda.controller.show', function () {
      routerStub.get.withArgs('/:id', 'agendaCtrl.show').should.have.been.calledOnce;
    });
  });
  ...
  describe('POST /api/agendas', function () {
    ...
    it('should route to agenda.controller.create', function () {
      routerStub.post.withArgs('/', 'agendaCtrl.create').should.have.been.calledOnce;
    });
  });

  describe('PUT /api/agendas/:id', function () {

    it('should route to agenda.controller.update', function () {
      routerStub.put.withArgs('/:id', 'agendaCtrl.update').should.have.been.calledOnce;
    });
  });
  ...
  describe('PATCH /api/agendas/:id', function () {
    ...
    it('should route to agenda.controller.update', function () {
      routerStub.patch.withArgs('/:id', 'agendaCtrl.update').should.have.been.calledOnce;
    });
  });
  ...
  describe('DELETE /api/agendas/:id', function () {
    ...
    it('should route to agenda.controller.destroy', function () {
      routerStub['delete'].withArgs('/:id', 'agendaCtrl.destroy').should.have.been.calledOnce;
    });
  });
});
