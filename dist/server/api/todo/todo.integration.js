...
describe('Todo API:', function () {
  ...
  describe('GET /api/todos', function () {
    ...
    beforeEach(function (done) {
      (0, _supertest2['default'])(app).get('/api/todos').expect(200).expect('Content-Type', /json/).end(function (err, res) {
        if (err) {
          return done(err);
        }
        todos = res.body;
  ...
  describe('POST /api/todos', function () {
    beforeEach(function (done) {
      (0, _supertest2['default'])(app).post('/api/todos').send({
        name: 'New Todo',
  ...
  describe('GET /api/todos/:id', function () {
    ...
    beforeEach(function (done) {
      (0, _supertest2['default'])(app).get('/api/todos/' + newTodo._id).expect(200).expect('Content-Type', /json/).end(function (err, res) {
        if (err) {
          return done(err);
        }
        todo = res.body;
  ...
  describe('PUT /api/todos/:id', function () {
    ...
    beforeEach(function (done) {
      (0, _supertest2['default'])(app).put('/api/todos/' + newTodo._id).send({
        name: 'Updated Todo',
  ...
  describe('DELETE /api/todos/:id', function () {
    ...
    it('should respond with 204 on successful removal', function (done) {
      (0, _supertest2['default'])(app)['delete']('/api/todos/' + newTodo._id).expect(204).end(function (err, res) {
        if (err) {
          return done(err);
        }
        done();
    ...
    it('should respond with 404 when todo does not exist', function (done) {
      (0, _supertest2['default'])(app)['delete']('/api/todos/' + newTodo._id).expect(404).end(function (err, res) {
        if (err) {
          return done(err);
        }
        done();
...
//# sourceMappingURL=todo.integration.js.map
